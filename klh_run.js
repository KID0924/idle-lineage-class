        ...
        if (headerDiv && mainMenu) {
            ...
            announceDiv.innerHTML = `
                ...
                <div class="text-xs sm:text-sm text-slate-300 leading-relaxed flex flex-col gap-2.5">
                    ...
                    <p>近期看到原作者在遊戲平衡上下了非常多心血，出於對原作者的尊重，同時考量到未來可能面臨的系統檢測風險（因本人兩週前才剛開始接觸 JavaScript，時間、能力實在有限）。雖然目前存檔轉移功能一切正常，我們仍決定做出以下調整：</p>
                    <div class="border-t border-rose-900/50 pt-2.5 mt-1 flex flex-col gap-1.5">
                        ...
                        <p class="text-yellow-400 font-bold"><span class="text-rose-400">●</span> 網站關閉與存檔保留： <span class="text-yellow-300">本網站將於 7 月 7 日後正式關閉，資料僅保留至該日。請大家務必儘早完成遷移，切勿拖到最後一天，以免因網站關閉導致心血遺失！</span></p>
                    </div>
